...
public class MainActivity extends AppCompatActivity implements TasksAdapter.DeleteTaskListener {
     ...
     */
    private Project[] projectsArray = new Project[]{};
    ...
    private void configViewModel() {
        ...
        projectViewModel.getAllProjects().observe(this, new Observer<List<Project>>() {
            ...
            public void onChanged(@Nullable List<Project> projects) {
                projectsArray =  projects.toArray(projectsArray);
    ...
    private void onPositiveButtonClick(DialogInterface dialogInterface) {
        ...
        if (dialogEditText != null && dialogSpinner != null) {
            ...
            // If both project and name of the task have been set
                ...
                Log.d("MainProjectId", String.valueOf(taskProject.getId()));
                Task task = new Task(
                        taskProject.getId(),
                        taskName,
                        new Date().getTime()
    ...
    private void populateDialogSpinner() {
        final ArrayAdapter<Project> adapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, projectsArray);
